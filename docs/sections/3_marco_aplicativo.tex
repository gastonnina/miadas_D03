...
Se empleará un modelo inicial de embeddings \texttt{sentence-transformers/all-MiniLM-L6-v2}, cuyas representaciones de 384 dimensiones se almacenarán en PostgreSQL con \texttt{pgvector}. Esta configuración permite búsquedas semánticas, filtros estructurados y estrategias híbridas.
